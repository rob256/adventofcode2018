...
def get_answer(input_text: str) -> int:
    ...
    previous = sum_plants(new_state)
    for i in range(generations):
        new_state = apply_rules(new_state, rules)
        next_sum = sum_plants(new_state)
        print(f'{i + 1}: {next_sum} , {next_sum - previous}')
        previous = next_sum
    print()
...
def get_future_plant_sum(future_year):
    return (62 * future_year) - 509


if __name__ == '__main__':
    # main()
    # print(152631 + (62 * (50000000000 - 1000)))
    # print(get_future_plant_sum(1000))  # 61491
    # print(get_future_plant_sum(50000000000))
    print(get_future_plant_sum(200))
